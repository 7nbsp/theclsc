...
//								$('<a href="#" class="selecteee">aaa</a>'),
				...
				$pop.append(
						jQuery('<div style="text-align:center;border-bottom:solid 1px #328AB2;border-left:solid 1px #328AB2;border-right:solid 1px #328AB2;"><strong>' + ameAjaxL10n.Time + ':</strong> <input name="ame_hour" id="ame_hour" type="text" size="1" maxlength="2" value="12" style="font-size:0.85em;padding:1px;" />:<input name="ame_minutes" id="ame_minutes" type="text" size="1" maxlength="2" value="00" style="font-size:0.85em;padding:1px;" /></div>')
				);
