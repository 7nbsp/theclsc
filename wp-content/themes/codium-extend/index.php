<?php get_header(); ?>
	<div id="container">
		<div id="content"> 
		<?php echo $author_id; ?>
			<?php $posts = get_posts('author='.$author_id); ?>
				...
				<div class="entry-date"><?php unset($previousday); printf(__('%1$s &#8211; %2$s', 'codium_extend'), the_date('', '', '', false), get_the_time()) ?></div> 
					...
					<?php wp_link_pages("\t\t\t\t\t<div class='page-link'>".__('Pages: ', 'codium_extend'), "</div>\n", 'number'); ?>
						...
						<div class="entry-meta">
							...
							<span class="comments-link"><?php comments_popup_link(__('Responses (0)', 'codium_extend'), __('Response (1)', 'codium_extend'), __('Responses (%)', 'codium_extend')) ?></span> 
