...
<div class="login profile" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<form id="your-profile" action="" method="post">
		...
		*/ ?>
		...
		<?php if($subsonly==0){echo '<div style="display: none;">';} ?>
			<?php do_action( 'profile_personal_options', $profileuser ); ?>
		<?php if($subsonly==0){echo '</div>';} ?>
		
		<?php if($subsonly==1){echo '<div style="display: none;">';} ?>
		...
		<tr>
			<th><label for="nickname"><?php _e( 'Nickname', 'theme-my-login' ); ?><br /> <span class="description"><?php _e( '<small>(required)</small>', 'theme-my-login' ); ?></span></label></th>
			<td><input type="text" name="nickname" id="nickname" value="<?php echo esc_attr( $profileuser->nickname ) ?>" class="regular-text" /></td>
		</tr>

		<tr>
			<th><label for="display_name"><?php _e( 'Display name', 'theme-my-login' ) ?></label></th>
			<td>
		...
		<table class="form-table">
		<tr>
			<th><label for="email"><?php _e( 'E-mail', 'theme-my-login' ); ?><br /> <span class="description"><?php _e( '<small>(required)</small>', 'theme-my-login' ); ?></span></label></th>
...
<br />
		<h3><?php _e( 'Change Password', 'theme-my-login' ); ?></h3>
		...
		<tr id="password">
			...
			<td><span class="description"><?php _e( 'To change the password type a new one. Otherwise leave blank.', 'theme-my-login' ); ?></span><br />
			<input type="password" name="pass1" id="pass1" size="16" value="" autocomplete="off" /><br />
